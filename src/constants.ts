export const COUNTRIES = [
  ...
  { name: 'Algeria', code: 'DZ', currency: 'DZD', symbol: 'DA' },
  ...
  { name: 'Bahrain', code: 'BH', currency: 'BHD', symbol: 'BD' },
  ...
  { name: 'Jordan', code: 'JO', currency: 'JOD', symbol: 'JD' },
  ...
  { name: 'Korea, North', code: 'KP', currency: 'KPW', symbol: '₩' },
  { name: 'Korea, South', code: 'KR', currency: 'KRW', symbol: '₩' },
  { name: 'Kuwait', code: 'KW', currency: 'KWD', symbol: 'KD' },
  ...
  { name: 'Lebanon', code: 'LB', currency: 'LBP', symbol: 'L£' },
  ...
  { name: 'Oman', code: 'OM', currency: 'OMR', symbol: 'RO' },
  ...
  { name: 'Qatar', code: 'QA', currency: 'QAR', symbol: 'QR' },
  ...
  { name: 'Syria', code: 'SY', currency: 'SYP', symbol: 'LS' },
  ...
  { name: 'Uzbekistan', code: 'UZ', currency: 'UZS', symbol: 'soʻm' },
...
export const PROPERTY_TYPES = [
  'Apartment', 'Villa', 'House', 'Studio', 'Office', 'Townhouse', 'Penthouse', 'Land', 'Commercial'
];
