  ...
  return (
    <LegalLayout title="Refund Policy">
      ...
      <section className="mb-12">
        ...
        <p>listing pilot sells its services through Paddle, which acts as the Merchant of Record for all transactions. Paddle manages payments, taxes, and refund processing for our platform. We aim to provide the highest quality AI listing services and ensure a transparent refund process for all our customers.</p>
      </section>
      ...
      <section className="mb-12">
        ...
        <p>Refund requests are handled by Paddle, our Merchant of Record. You may submit a refund request through Paddle's support channels or by contacting us directly at support@listingpilot.ai. When contacting us, please include your account details and the transaction date to help us expedite the process with Paddle.</p>
      </section>
      ...
      <section className="mb-12">
        ...
        <p>Once a refund is approved by Paddle, it typically takes 3-5 business days for the funds to appear back in your original payment method. Please note that processing times may vary depending on your financial institution.</p>
      </section>
    </LegalLayout>
  );
};
